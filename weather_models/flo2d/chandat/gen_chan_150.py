...
ROOT_DIRECTORY = r"C:\workflow\flo2d_150m"
...
def write_file_to_file(file_name, file_content):
    print('write_file_to_file|file_name : ', file_name)
    with open(file_name, 'w+') as f:
        f.write(file_content)


def write_to_file(file_name, data):
    print('write_file_to_file2|file_name : ', file_name)
    with open(file_name, 'w+') as f:
        f.write('\n'.join(data))


def append_to_file(file_name, data):
    print('append_to_file|file_name : ', file_name)
...
def append_file_to_file(file_name, file_content):
    print('append_to_file2|file_name : ', file_name)
    with open(file_name, 'a+') as f:
        f.write('\n')
        f.write(file_content)
...
def prepare_chan(chan_file_path, start, flo2d_model):
    print('prepare_chan|chan_file_path : ', chan_file_path)
...
def create_chan(output_dir, start_time, flo2d_model):
    file_name = 'CHAN.DAT'
    print('create_chan|output_dir : ', output_dir)
