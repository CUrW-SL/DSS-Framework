...
def get_push_command(**context):
    wrf_rule = context['task_instance'].xcom_pull(task_ids='init_wrfv4C')
    ...
    push_wrf4_C_cmd = ssh_cmd_template.format(push_node, push_script)
    print('get_push_command|push_wrf4_C_cmd : ', push_wrf4_C_cmd)
    subprocess.call(push_wrf4_C_cmd, shell=True)
...
def get_wrf_run_command(**context):
    ...
    run_wrf4_C_cmd = ssh_cmd_template.format(run_node, run_script)
    print('get_wrf_run_command|run_wrf4_C_cmd : ', run_wrf4_C_cmd)
    subprocess.call(run_wrf4_C_cmd, shell=True)
...
def run_this_func(dag_run, **kwargs):
    ...
    wrf_rule = {'model': 'C', 'version': '4.1.2', 'rule_info': dag_run.conf}
...
with DAG(dag_id=prod_dag_name, default_args=default_args, schedule_interval=None,
         description='Run WRF v4 C DAG', dagrun_timeout=timedelta(hours=9), catchup=False,
    ...
    wrf_data_push_wrfv4C = PythonOperator(
    ...
    run_wrf4_C >> wrf_data_push_wrfv4C >> check_accuracy_wrfv4C >> complete_state_wrfv4C
