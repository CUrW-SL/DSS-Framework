...
with DAG(dag_id=prod_dag_name, default_args=default_args, schedule_interval=None,
    ...
    check_wrf_completion_flo2d_30m = WorkflowSensorOperator(
        task_id='check_wrf_completion_flo2d_30m',
        poke_interval=60,
        timeout=60 * 6 * 60,
        params={'model': 'wrf', 'init_task_id': 'init_flo2d_30m'},
        provide_context=True,
        dag=dag)
    ...
    check_hechms_completion_flo2d_30m = WorkflowSensorOperator(
        task_id='check_hechms_completion_flo2d_30m',
        poke_interval=60,
        timeout=30,
        params={'model': 'hechms', 'init_task_id': 'init_flo2d_30m'},
        provide_context=True,
        dag=dag)
    ...
    init_flo2d_30m >> running_state_flo2d_30m >> check_wrf_completion_flo2d_30m >> create_raincell_flo2d_30m >> \
    check_hechms_completion_flo2d_30m >> create_inflow_flo2d_30m >> create_outflow_flo2d_30m >> run_flo2d_30m >> \
    extract_water_level_flo2d_30m >> complete_state_flo2d_30m
