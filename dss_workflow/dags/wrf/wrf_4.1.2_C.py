...
run_wrf4_C_cmd_template = "ssh -i /home/uwcc-admin/.ssh/uwcc-admin -o \"StrictHostKeyChecking no\" uwcc-admin@{} " \
                          "\'bash -c \"{}\"'"
...
def get_wrf_run_command(**context):
    ...
    run_wrf4_C_cmd = run_wrf4_C_cmd_template.format(run_node, run_script)
